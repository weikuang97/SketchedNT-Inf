function StoNewton(c1,c2,c3,Max_Iter,ttau,nx,X_true,Sigma,Xistar,q,mu)
    ## Set Buffer Size
    Buff= Int(1e5)
    ...
    cum_bar2x_f_t,B_t,pert = Matrix(1.0I,nx,nx),zeros(nx,nx),mu*Matrix(1.0I,nx,nx) # plug-in & sample cov estimator
